...
Check: not IsMultiUserInstall; ValueName: Publisher; ValueData: {#COMPANY}; ValueType: string; Root: HKCU; Subkey: {code:GetRegKey}; Flags: uninsdeletekey
...
Check: IsMultiUserInstall; ValueName: Publisher; ValueData: {#COMPANY}; ValueType: string; Root: HKLM32; Subkey: {code:GetRegKey}; Flags: uninsdeletekey
...
Check: IsMultiUserInstall and IsWin64; ValueName: Publisher; ValueData: {#COMPANY}; ValueType: string; Root: HKLM64; Subkey: {code:GetRegKey}; Flags: uninsdeletekey
